...
public class MyGridViewAdapter extends BaseAdapter {
    ...
    private OnImgItemLongClickListener imgLongClickListener;
...
//                Toast.makeText(context,"你点击了 "+listData.get(pos).getAppName(),Toast.LENGTH_SHORT).show();
        ...
        holder.imgUrl.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                imgLongClickListener.onClick(position);
                return true;
            }
        });
        return convertView;
    ...
    public void setOnImgItemLongClickListener(OnImgItemLongClickListener itemLongClickListener) {
        this.imgLongClickListener = itemLongClickListener;
    }

    public interface OnImgItemLongClickListener {
